...
This repository is the monorepo for my public web properties:

- `dev/` — developer portfolio and case studies  
- `music/` — teaching and performance site  
- `www/` — main landing page  

Each app is built independently and deployed separately, but maintained together for shared branding and consistency.

Built with Next.js, TypeScript, Tailwind CSS, shadcn/ui, and Vercel.
</details>
